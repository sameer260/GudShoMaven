...
public class CreateStudioSteps extends Base_setup {
	   ...
	   public void go_to_create_studio_page_tab_from_profile() throws Throwable {
	       ...
	       log.info(Heading);
	       Assert.assertEquals(Heading, "Create Studio Page");
	       String description=CreateStudioandsettings.CreateStudioPageDescription.getText();
	       log.info(description);
	       Assert.assertEquals(description, "Get started by giving few details about your studio"); 
	    ...
	    public void it_should_redirect_to_home_page() throws Throwable {
	       Assert.assertTrue(socialpageandsearch.logoheaderm().isDisplayed());
	       Assert.assertTrue(socialpageandsearch.homepagesearch().isDisplayed());
	    }
	    ...
	    public void check_first_tab_is_displaying_with_something(String strArg1) throws Throwable {
	    	...
	    	Assert.assertEquals(strArg1, firsttabheading);
	    }
	    ...
	    public void check_second_tab_is_diaplaying_with_something(String strArg1) throws Throwable {
	    	...
	    	Assert.assertEquals(strArg1, secondtabheading);
	    }
	    ...
	    public void check_third_tab_is_dispaying_with_something(String strArg1) throws Throwable {
	    	...
	    	Assert.assertEquals(strArg1, Thirdtabheading);
	    }
	    ...
	    public void input_the_in_to_the_field(String studioname) throws Throwable {
	    	...
	    	Assert.assertEquals(Studionameonprofilepreview, studioname);
	    }
	    ...
	    public void give_and_available_text_should_show_something(String validstudioname, String availablemessage) throws Throwable {
	    	...
	    	Assert.assertEquals(avilabletextinfield, availablemessage);	
	    	String Studionameonprofilepreview=CreateStudioandsettings.StudioNameinStudioProfilepreview.getText();
	    	log.info(Studionameonprofilepreview);
	    	Assert.assertEquals(Studionameonprofilepreview, validstudioname);
	    }
	    ...
	    public void check_something_is_displaying(String studioprofilefieldname) throws Throwable {
	    	...
	    	Assert.assertEquals(Studioprofilefieldname,studioprofilefieldname);
	    }
	    ...
	    public void check_the_description_of_filed_name_is_something_displaying(String studioprofiledescription) throws Throwable {
	    	...
	    	Assert.assertEquals(studioprofiledescriptiont, studioprofiledescription);
	    }
	    ...
	    public void uploaded_image_has_been_displayed_in_studio_preview() throws Throwable {
	    	Assert.assertTrue(CreateStudioandsettings.StudioImageInProfilePreview.isDisplayed());
	    }
	    ...
	    public void the_file_supported_text_is_displaying() throws Throwable {
	    	...
	    	Assert.assertEquals("Recommended height 200px JPEGs, and PNGs supported.", thumbnailsupporttext);
	    }
	    ...
	    public void delete_the_uploaded_profile_pic_and_the_errormessage_should_show_something(String fielderrormessage) throws Throwable {
	        ...
	        Assert.assertEquals(errormessage, fielderrormessage);
	    }
	    ...
	    public void about_studio_field_name_should_display_something(String aboutstudiofield) throws Throwable {
	    	...
	    	Assert.assertEquals(aboutstudiofield, aboutstudiofieldactual);
	    ...
	    public void give_description_in_to_the_field_as_something(String studiodescription) throws Throwable {
	        ...
	        log.info(description);
	        Assert.assertEquals(description, studiodescription);
	    ...
	    public void about_studio_field_description_should_display_something(String aboutstudiofielddesc) throws Throwable {
	    	...
	    	Assert.assertEquals(aboutstudiodescactual, aboutstudiofielddesc);
	    }
	    ...
	    public void the_description_place_holder_should_display_something(String descplaceholder) throws Throwable {
	    	...
	    	Assert.assertEquals(Placeholder, descplaceholder);
	    	
	    }

	    @And("^The Description chracter count$")
	    public void the_description_chracter_count() throws Throwable {
	        Assert.assertTrue(CreateStudioandsettings.StuioDescriptionChractersCount.isDisplayed());
	    ...
	    public void studio_visibility_field_name_something(String studiovisibilityname) throws Throwable {
	    	...
	    	Assert.assertEquals(Studiovisibilityfieldname, studiovisibilityname);
	    }
	    ...
	    public void studio_visibility_description_something(String visbilitydesc) throws Throwable {
	    	...
	    	Assert.assertEquals(studiovisibilitydesc, visbilitydesc);
	    }
	    ...
	    public void check_all_the_social_icon_field_names() throws Throwable {
	    	...
	    	Assert.assertEquals(CreateStudioandsettings.FieldNames.get(3).getText(), "Facebook");
	    	Assert.assertEquals(CreateStudioandsettings.FieldNames.get(4).getText(), "Twitter");
	    	Assert.assertEquals(CreateStudioandsettings.FieldNames.get(5).getText(), "Linkedin");
	    	Assert.assertEquals(CreateStudioandsettings.FieldNames.get(6).getText(), "Instagram");
	    	Assert.assertEquals(CreateStudioandsettings.FieldNames.get(7).getText(), "Website");
	    ...
	    public void check_all_the_placeholders_of_the_social_icon_fields() throws Throwable {
	    	Assert.assertEquals(CreateStudioandsettings.FacebookField.getAttribute("placeholder"), "https://www.facebook.com/YourStudioLink");
	    	Assert.assertEquals(CreateStudioandsettings.TwitterField.getAttribute("placeholder"), "https://www.twitter.com/YourStudioLink");
	    	Assert.assertEquals(CreateStudioandsettings.LinkedinField.getAttribute("placeholder"), "https://www.linkedin.com/yourstudiolink");
	    	Assert.assertEquals(CreateStudioandsettings.InstagramField.getAttribute("placeholder"), "https://www.instagram.com/yourstudiolink");
	    	Assert.assertEquals(CreateStudioandsettings.WebSiteField.getAttribute("placeholder"), "https://www.yourwebsite.com");
	    }
	    ...
	    public void to_check_all_the_field_error_messages() throws Throwable {
	    	...
	    	Assert.assertEquals(CreateStudioandsettings.ErrorMessages.getText(), "Please upload image");
	    	log.info(CreateStudioandsettings.HeadderErrorMessage.getText());
	    	Assert.assertEquals(CreateStudioandsettings.HeadderErrorMessage.getText(), "Sorry! Please continue filling all the mandatory fields.");
	    	...
	    	CreateStudioandsettings.CreateStudioPageButton.click();
	    	log.info(CreateStudioandsettings.ErrorMessages.getText());
	    	Assert.assertEquals(CreateStudioandsettings.ErrorMessages.getText(), "Please fill the description");
	    	log.info(CreateStudioandsettings.HeadderErrorMessage.getText());
	    	Assert.assertEquals(CreateStudioandsettings.HeadderErrorMessage.getText(), "Sorry! Please continue filling all the mandatory fields.");
	    	...
	    	CreateStudioandsettings.CreateStudioPageButton.click();
	    	log.info(CreateStudioandsettings.ErrorMessages.getText());
	    	Assert.assertEquals(CreateStudioandsettings.ErrorMessages.getText(), "Please choose the status");
	    	log.info(CreateStudioandsettings.HeadderErrorMessage.getText());
	    	Assert.assertEquals(CreateStudioandsettings.HeadderErrorMessage.getText(), "Sorry! Please continue filling all the mandatory fields.");
	    ...
	    public void check_the_invalid_urls() throws Throwable {
	    	...
	    	Assert.assertEquals(invalidurlforfacebook1, "Only URL allowed");
	    	CreateStudioandsettings.FacebookField.clear();
	    	CreateStudioandsettings.FacebookField.sendKeys("https://facebook.com");
	    	Assert.assertTrue(CreateStudioandsettings.SocilaIconsInStudioPreview.get(0).isEnabled());
	    	...
	    	Assert.assertEquals(invalidtwitter, "Only URL allowed");
	    	CreateStudioandsettings.TwitterField.clear();
	    	CreateStudioandsettings.TwitterField.sendKeys("https://twitter.com");
	    	Assert.assertTrue(CreateStudioandsettings.SocilaIconsInStudioPreview.get(1).isEnabled());
	    	...
	    	Assert.assertEquals(invalidlinkedin, "Only URL allowed");
	    	CreateStudioandsettings.LinkedinField.clear();
	    	CreateStudioandsettings.LinkedinField.sendKeys("https://linkedin.com");
	    	Assert.assertTrue(CreateStudioandsettings.SocilaIconsInStudioPreview.get(2).isEnabled());
	    	...
	    	Assert.assertEquals(invalidinstagram, "Only URL allowed");
	    	CreateStudioandsettings.InstagramField.clear();
	    	CreateStudioandsettings.InstagramField.sendKeys("https://instagram.com");
	    	Assert.assertTrue(CreateStudioandsettings.SocilaIconsInStudioPreview.get(3).isEnabled());
	    	...
	    	Assert.assertEquals(invalidwebsite, "Only URL allowed");
	    	CreateStudioandsettings.WebSiteField.clear();
	    	CreateStudioandsettings.WebSiteField.sendKeys("https://gudsho.com");
	    	Assert.assertTrue(CreateStudioandsettings.SocilaIconsInStudioPreview.get(4).isEnabled());
	    ...
	    public void the_studio_name_field_name_is_something(String studioownername) throws Throwable {
	    	...
	    	Assert.assertEquals(Studioownername, studioownername);
	    	String placeholder=CreateStudioandsettings.StudioOwnerName.getAttribute("placeholder");
	    	log.info(placeholder);
	    	Assert.assertEquals("Enter your Name", placeholder);
	    }
	    ...
	    public void the_email_address_field_name_is_something(String Fieldname) throws Throwable {
	    	...
	    	Assert.assertEquals(Emailfieldname, Fieldname);
	    	...
	    	log.info(placeholder);
	    	Assert.assertEquals("Enter Mail Id", placeholder);
	    }
	    ...
	    public void the_phone_number_field_name_is_something(String Fieldname) throws Throwable {
	    	...
	    	Assert.assertEquals(phonenumberfield, Fieldname);
	    ...
	    public void the_studio_name_description_is_something(String description) throws Throwable {
	        ...
	        Assert.assertEquals(studioownerdesc, description);
	    }
	    ...
	    public void the_email_address_field_description_is_something(String description) throws Throwable {
	        ...
	        log.info(emaildesc);
	        Assert.assertEquals(emaildesc, description);
	    }
	    ...
	    public void the_phone_number_field_escription_is_something(String description) throws Throwable {
	        ...
	        Assert.assertEquals(phonenumberdesc, description);
	    }
	    ...
	    public void give_studio_owner_name_as(String ownername) throws Throwable {
	    	...
	    	Assert.assertEquals(errormessage1,"Studio Owner Name is required");
	    	...
	    	Assert.assertEquals(errormessage2, "Minimum 3 characters allowed");
	    ...
	    public void edit_the_email_field_and_give_inavlid_email_id() throws Throwable {
	    	...
	    	log.info(errormessage1);
	    	Assert.assertEquals(errormessage1, "Email must be a valid email address");
	    ...
	    public void edit_the_phone_number_field_and_check_request_otp_button_is_disabled() throws Throwable {
	    	...
	    	Thread.sleep(2000);
	    	Assert.assertTrue(CreateStudioandsettings.OTPPopupWindowtext.isDisplayed());
	    	log.info(CreateStudioandsettings.OTPPopupWindowtext.getText());
	    	Assert.assertEquals(CreateStudioandsettings.OTPPopupWindowtext.getText(), "Verify your phone");
	    	...
	    	log.info(errormessage1);
	    	Assert.assertEquals("Please enter valid mobile number", errormessage1);
	    	CreateStudioandsettings.PhoneNumberFieldinPopup.clear();
	    	...
	    	log.info(errormessage2);
	    	Assert.assertEquals("Please enter valid mobile number", errormessage2);
	    	CreateStudioandsettings.PhoneNumberFieldinPopup.clear();
	    	CreateStudioandsettings.PhoneNumberFieldinPopup.sendKeys("9542840307");
	    	Assert.assertTrue(CreateStudioandsettings.RequestOTPButton.isEnabled());
	    	Thread.sleep(500);
	    	/*Actions a=new Actions(driver);
	    ...
	    public void the_studio_address_field_name_is_something(String FieldName) throws Throwable {
	    	...
	    	Assert.assertEquals(FieldName, StudioAddressFiledName);
	    }
	    ...
	    public void the_studio_address_field_description_is_something(String Fileddesc) throws Throwable {
	    	...
	    	log.info(Description);
	    	Assert.assertEquals(Fileddesc, Description);
	    }
	    ...
	    public void check_the_errormessage() throws Throwable {
	    	...
	    	String Errormessage=CreateStudioandsettings.ErrorMessages.getText();
	    	log.info(Errormessage);
	    	Assert.assertEquals(Errormessage, "Studio Address is required");
	    ...
	    public void the_footer_text_should_match_and_check_box_should_select() throws Throwable {
	    	...
	    	log.info(text);
	    	Assert.assertEquals(text, "I verify that I'am an authorized representative "
	    ...
	    public void after_filling_all_details_do(String action) throws Throwable {
			...
			else if(action.equalsIgnoreCase("createstudio"))
			{
				...
				Assert.assertTrue(CreateStudioandsettings.StudioImageInProfilePreview.isDisplayed());
				Assert.assertTrue(CreateStudioandsettings.StudioVisiblity.get(0).isDisplayed());
				wait.until(ExpectedConditions.textToBePresentInElement(CreateStudioandsettings.SavedText, "Saved"));
				Assert.assertEquals(CreateStudioandsettings.SavedText.getText(), "Saved");
				Assert.assertTrue(CreateStudioandsettings.SavedText.isDisplayed());
				Assert.assertTrue(CreateStudioandsettings.PublishButton.isDisplayed());
				Assert.assertTrue(CreateStudioandsettings.StudioSettingsbutton.isDisplayed());
				Assert.assertEquals(CreateStudioandsettings.Studionameaftercreatestudio.getText(), studioname);
				CreateStudioandsettings.PublishButton.click();
				String toastmessage=Toastanderrormessages.toastmessagem().getText();
				Assert.assertEquals(toastmessage, "Your Studio has been published successfully");	
			}
	    }
	    ...
	    public void gather_all_studio_info_in_my_studio_page_and_check_the_same_in_studio_preview_page() throws Throwable {
	        ...
	        {		
	         ...
	         {    	
	         	...
	         	Assert.assertEquals(Studionameinpreviewpage, Studionameinpreviewpage);
	         	Assert.assertTrue(CreateStudioandsettings.StudioImageinPreviewPage.isDisplayed());
	         	Assert.assertTrue(CreateStudioandsettings.FollowButtoninPreviewPage.isDisplayed());
	         	Assert.assertTrue(CreateStudioandsettings.InfoButtoninPreviewPage.isDisplayed());
	         	Assert.assertTrue(CreateStudioandsettings.SocialShareButtons.isDisplayed());
	         	CreateStudioandsettings.InfoButtoninPreviewPage.click();
	         	Assert.assertTrue(CreateStudioandsettings.FollowUsOnButton.isDisplayed());
	         	Assert.assertTrue(CreateStudioandsettings.DescriptioninPrviewPage.isDisplayed());
	            driver.close();
	    ...
	    public void go_to_frontend_and_search_the_studio() throws Throwable {
	        ...
	        try {
	        	...
	        	Assert.assertTrue(str.equalsIgnoreCase(StudioName));
	        }
	        catch(Exception e)
	        {
	        	Assert.assertTrue(socialpageandsearch.nosearchfoundtext().isDisplayed());
	        	Assert.assertEquals(socialpageandsearch.nosearchfoundtext().getText(),"No Search Results Found");
	    ...
	    public void check_all_the_field_names_are_displaying() throws Throwable {
	    	...
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(0).getText(), "Studio Picture *");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(1).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(1).getText(), "About Studio*");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(2).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(2).getText(), "Studio Visibility*");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(3).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(3).getText(), "Facebook");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(4).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(4).getText(), "Twitter");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(5).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(5).getText(), "Linkedin");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(6).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(6).getText(), "Instagram");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(7).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(7).getText(), "Website");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(8).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(8).getText(), "Studio Owner Name*");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(9).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(9).getText(), "Email Address*");
	    	log.info(CreateStudioandsettings.StudioFieldNames.get(10).getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioFieldNames.get(10).getText(), "Phone Number*");
	    	log.info(CreateStudioandsettings.StudioAddressFieldinStudioSettings.getText());
	    	Assert.assertEquals(CreateStudioandsettings.StudioAddressFieldinStudioSettings.getText(), "Studio Address*");	
	    }
	    ...
	    public void the_file_supported_text_is_showing() throws Throwable {
	    	...
	    	String str1=str.replace("\n", " ");
	    	log.info(str1);
	    	Assert.assertEquals("Recommended height 200px JPEGs, and PNGs supported.", str1);
	    ...
	    public void edit_the_studio_profile_image() throws Throwable {
        	...
        	String actualtoastmessage=Toastanderrormessages.alerdailogm().getText();
        	log.info(actualtoastmessage);
        	Assert.assertEquals(actualtoastmessage, "Recommended height 200px");
	    	...
	    	Thread.sleep(1000);
	    	CreateStudioandsettings.ThumbnailSavebutton.click();
	    	Assert.assertTrue(CreateStudioandsettings.SaveButtoninSettings.isEnabled());
	    	...
	    	Assert.assertEquals("Studio details has been saved successfully", actualtoast1);
	    ...
	    public void enter_more_description_and_check_the_chracters_count_are_showing() throws Throwable {
	    	...
	    	String placeholder=CreateStudioandsettings.StudioDescription.getAttribute("placeholder");
	    	Assert.assertEquals("Description", placeholder);
	    	String Actualerror=CreateStudioandsettings.ErrorMessagesinStudioSettings.getText();
	    	log.info(Actualerror);
	    	Assert.assertEquals("Actualerror", "Please fill the description");*/
	    ...
	    public void the_studio_owner_name_field_name_as_something(String studioownerfiledname) throws Throwable {
	    	...
	    	Assert.assertEquals(expectedname, studioownerfiledname);
	    }
	    ...
	    public void check_the_studio_owner_name_placeholder() throws Throwable {
	    	...
	    	Assert.assertEquals(actualplaceholder, "Enter your Name");
	    }
	    ...
	    public void check_the(String invaliderrormessage) throws Throwable {
	    	...
	    	Assert.assertEquals(expectederror, invaliderrormessage);
	    }
	    ...
	    public void check_the_email_id_placeholder() throws Throwable {
	    	...
	    	Assert.assertEquals(expected, "Enter Mail Id");
	    }
	    ...
	    public void clear_the_field_and_check_the_placeholder() throws Throwable {
	    	...
	    	log.info(actual);
	    	Assert.assertEquals(actual, "Enter your Address");
	    	Thread.sleep(20000);
	    }
